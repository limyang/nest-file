...
final class ReaderImpl implements Reader {
	...
	public Iterable<StripeInformation> getStripes() {
		return new Iterable<com.ebay.nest.io.nestfile.StripeInformation>() {

			@Override
			public Iterator<com.ebay.nest.io.nestfile.StripeInformation> iterator() {
				return new Iterator<com.ebay.nest.io.nestfile.StripeInformation>() {
					...
					@Override
					public com.ebay.nest.io.nestfile.StripeInformation next() {
