...
public abstract class ShimLoader {
	...
	/**
	 * Return the "major" version of Hadoop currently on the classpath. For releases in the 0.x series this is simply
	 * the first two components of the version, e.g. "0.20" or "0.23". Releases in the 1.x and 2.x series are mapped to
	 * the appropriate 0.x release series, e.g. 1.x is mapped to "0.20S" and 2.x is mapped to "0.23".
	 */
