...
/**
 * StandardMapObjectInspector works on map data that is stored as a Java Map object. Note: the key object of the map
 * must support equals and hashCode by itself.
 * 
 * We also plan to have a GeneralMapObjectInspector which can work on map with key objects that does not support equals
 * and hashCode. That will require us to store InspectableObject as the key, which will have overridden equals and
 * hashCode methods.
 * 
...
public class StandardMapObjectInspector implements SettableMapObjectInspector {
	...
	public String getTypeName() {
		return serdeConstants.MAP_TYPE_NAME + "<" + mapKeyObjectInspector.getTypeName() + ","
