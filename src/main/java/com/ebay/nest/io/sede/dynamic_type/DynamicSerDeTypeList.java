...
import com.ebay.nest.io.sede.thrift.WriteNullsProtocol;
...
public class DynamicSerDeTypeList extends DynamicSerDeTypeBase {
	...
	@Override
	public ArrayList<Object> deserialize(Object reuse, TProtocol iprot) throws SerDeException, TException,
	...
	@Override
	public void serialize(Object o, ObjectInspector oi, TProtocol oprot) throws TException, SerDeException,
