...
import com.ebay.nest.io.sede.DoubleWritable;
...
import com.ebay.nest.io.sede.lazy.LazyInteger;
...
public final class PrimitiveObjectInspectorUtils {
	...
	public static class PrimitiveTypeEntry implements Writable, Cloneable, PrimitiveTypeSpec {
		...
		PrimitiveTypeEntry(PrimitiveObjectInspector.PrimitiveCategory primitiveCategory, String typeName,
				Class<?> primitiveType, Class<?> javaClass, Class<?> hiveClass, Class<?> paramsClass) {
		...
		@Override
		public Object clone() {
			PrimitiveTypeEntry result = new PrimitiveTypeEntry(this.primitiveCategory, this.typeName,
					this.primitiveJavaType, this.primitiveJavaClass, this.primitiveWritableClass, this.typeParamsClass);
			return result;
		}
	...
	public static final PrimitiveTypeEntry binaryTypeEntry = new PrimitiveTypeEntry(PrimitiveCategory.BINARY,
			serdeConstants.BINARY_TYPE_NAME, byte[].class, byte[].class, BytesWritable.class, null);
	public static final PrimitiveTypeEntry stringTypeEntry = new PrimitiveTypeEntry(PrimitiveCategory.STRING,
			serdeConstants.STRING_TYPE_NAME, null, String.class, Text.class, null);
	public static final PrimitiveTypeEntry booleanTypeEntry = new PrimitiveTypeEntry(PrimitiveCategory.BOOLEAN,
			serdeConstants.BOOLEAN_TYPE_NAME, Boolean.TYPE, Boolean.class, BooleanWritable.class, null);
	public static final PrimitiveTypeEntry intTypeEntry = new PrimitiveTypeEntry(PrimitiveCategory.INT,
			serdeConstants.INT_TYPE_NAME, Integer.TYPE, Integer.class, IntWritable.class, null);
	public static final PrimitiveTypeEntry longTypeEntry = new PrimitiveTypeEntry(PrimitiveCategory.LONG,
			serdeConstants.BIGINT_TYPE_NAME, Long.TYPE, Long.class, LongWritable.class, null);
	public static final PrimitiveTypeEntry floatTypeEntry = new PrimitiveTypeEntry(PrimitiveCategory.FLOAT,
			serdeConstants.FLOAT_TYPE_NAME, Float.TYPE, Float.class, FloatWritable.class, null);
	public static final PrimitiveTypeEntry voidTypeEntry = new PrimitiveTypeEntry(PrimitiveCategory.VOID,
			serdeConstants.VOID_TYPE_NAME, Void.TYPE, Void.class, NullWritable.class, null);

	// No corresponding Writable classes for the following 3 in hadoop 0.17.0
	public static final PrimitiveTypeEntry doubleTypeEntry = new PrimitiveTypeEntry(PrimitiveCategory.DOUBLE,
			serdeConstants.DOUBLE_TYPE_NAME, Double.TYPE, Double.class, DoubleWritable.class, null);
	public static final PrimitiveTypeEntry byteTypeEntry = new PrimitiveTypeEntry(PrimitiveCategory.BYTE,
			serdeConstants.TINYINT_TYPE_NAME, Byte.TYPE, Byte.class, ByteWritable.class, null);
	public static final PrimitiveTypeEntry shortTypeEntry = new PrimitiveTypeEntry(PrimitiveCategory.SHORT,
			serdeConstants.SMALLINT_TYPE_NAME, Short.TYPE, Short.class, ShortWritable.class, null);
	public static final PrimitiveTypeEntry dateTypeEntry = new PrimitiveTypeEntry(PrimitiveCategory.DATE,
			serdeConstants.DATE_TYPE_NAME, null, Date.class, DateWritable.class, null);
	public static final PrimitiveTypeEntry timestampTypeEntry = new PrimitiveTypeEntry(PrimitiveCategory.TIMESTAMP,
			serdeConstants.TIMESTAMP_TYPE_NAME, null, Timestamp.class, TimestampWritable.class, null);
	public static final PrimitiveTypeEntry decimalTypeEntry = new PrimitiveTypeEntry(PrimitiveCategory.DECIMAL,
			serdeConstants.DECIMAL_TYPE_NAME, null, HiveDecimal.class, HiveDecimalWritable.class, null);
	public static final PrimitiveTypeEntry varcharTypeEntry = new PrimitiveTypeEntry(PrimitiveCategory.VARCHAR,
			serdeConstants.VARCHAR_TYPE_NAME, null, HiveVarchar.class, HiveVarcharWritable.class,
			VarcharTypeParams.class);

	// The following is a complex type for special handling
	public static final PrimitiveTypeEntry unknownTypeEntry = new PrimitiveTypeEntry(PrimitiveCategory.UNKNOWN,
			"unknown", null, Object.class, null, null);
	...
	public static PrimitiveTypeEntry getTypeEntryFromTypeSpecs(PrimitiveCategory primitiveCategory,
		...
		if (typeEntry == null) {
			...
			if (!typeEntry.isParameterized()) {
				throw new IllegalArgumentException(primitiveCategory + " type was being used with type parameters "
	...
	/**
	 * Compare 2 primitive objects. Conversion not allowed. Note that NULL does not equal to NULL according to SQL
	 * standard.
	 */
	public static boolean comparePrimitiveObjects(Object o1, PrimitiveObjectInspector oi1, Object o2,
		...
		case VARCHAR: {
			return ((HiveVarcharObjectInspector) oi1).getPrimitiveWritableObject(o1).equals(
					((HiveVarcharObjectInspector) oi2).getPrimitiveWritableObject(o2));
		}
		case DATE: {
			return ((DateObjectInspector) oi1).getPrimitiveWritableObject(o1).equals(
					((DateObjectInspector) oi2).getPrimitiveWritableObject(o2));
		}
		case TIMESTAMP: {
			return ((TimestampObjectInspector) oi1).getPrimitiveWritableObject(o1).equals(
					((TimestampObjectInspector) oi2).getPrimitiveWritableObject(o2));
		}
		case BINARY: {
			return ((BinaryObjectInspector) oi1).getPrimitiveWritableObject(o1).equals(
					((BinaryObjectInspector) oi2).getPrimitiveWritableObject(o2));
		}
		case DECIMAL: {
			return ((HiveDecimalObjectInspector) oi1).getPrimitiveJavaObject(o1).compareTo(
					((HiveDecimalObjectInspector) oi2).getPrimitiveJavaObject(o2)) == 0;
		}
		default:
			return false;
		}
	...
	/**
	 * Compare 2 Primitive Objects with their Object Inspector, conversions allowed. Note that NULL does not equal to
	 * NULL according to SQL standard.
	 */
	public static boolean comparePrimitiveObjectsWithConversion(Object o1, PrimitiveObjectInspector oi1, Object o2,
			PrimitiveObjectInspector oi2) {
		if (o1 == null || o2 == null) {
			return false;
		}
	...
	/**
	 * Get the boolean value out of a primitive object. Note that NullPointerException will be thrown if o is null. Note
	 * that NumberFormatException will be thrown if o is not a valid number.
	 */
	...
	/**
	 * Get the byte value out of a primitive object. Note that NullPointerException will be thrown if o is null. Note
	 * that NumberFormatException will be thrown if o is not a valid number.
	 */
	...
	/**
	 * Get the short value out of a primitive object. Note that NullPointerException will be thrown if o is null. Note
	 * that NumberFormatException will be thrown if o is not a valid number.
	 */
	...
	/**
	 * Get the integer value out of a primitive object. Note that NullPointerException will be thrown if o is null. Note
	 * that NumberFormatException will be thrown if o is not a valid number.
	 */
	...
	/**
	 * Get the long value out of a primitive object. Note that NullPointerException will be thrown if o is null. Note
	 * that NumberFormatException will be thrown if o is not a valid number.
	 */
	...
	/**
	 * Get the double value out of a primitive object. Note that NullPointerException will be thrown if o is null. Note
	 * that NumberFormatException will be thrown if o is not a valid number.
	 */
	...
	/**
	 * Get the float value out of a primitive object. Note that NullPointerException will be thrown if o is null. Note
	 * that NumberFormatException will be thrown if o is not a valid number.
	 */
	...
	/**
	 * Get the String value out of a primitive object. Note that NullPointerException will be thrown if o is null. Note
	 * that RuntimeException will be thrown if o is not a valid string.
	 */
	...
	public static enum PrimitiveGrouping {
		NUMERIC_GROUP, STRING_GROUP, BOOLEAN_GROUP, DATE_GROUP, BINARY_GROUP, VOID_GROUP, UNKNOWN_GROUP
	};

	/**
	 * Based on the PrimitiveCategory of a type, return the PrimitiveGrouping that the PrimitiveCategory belongs to
	 * (numeric, string, date, etc).
	 * 
	 * @param primitiveCategory
	 *            Primitive category of the type
	 * @return PrimitveGrouping corresponding to the PrimitiveCategory, or UNKNOWN_GROUP if the type does not match to a
	 *         grouping.
	 */
	...
	/**
	 * Helper class to store parameterized primitive object inspectors, which can be used by the various object
	 * inspector factory methods.
	 */
	public static class ParameterizedObjectInspectorMap {
		...
		public ParameterizedObjectInspectorMap() {
			entries = new HashMap<PrimitiveCategory, HashMap<String, PrimitiveObjectInspector>>();
		}
