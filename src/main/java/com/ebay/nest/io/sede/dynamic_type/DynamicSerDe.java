...
import com.ebay.nest.io.sede.thrift.ConfigurableTProtocol;
import com.ebay.nest.io.sede.thrift.TReflectionUtils;
...
public class DynamicSerDe extends AbstractSerDe {
	 ...
	 * For TCTLSeparatedProtocol for example, may want to query the separators.
	 */
	...
	public void initialize(Configuration job, Properties tbl) throws SerDeException {
		try {
			...
			if (oprot_ instanceof com.ebay.nest.io.sede.thrift.ConfigurableTProtocol) {
				((ConfigurableTProtocol) oprot_).initialize(job, tbl);
			}

			if (iprot_ instanceof com.ebay.nest.io.sede.thrift.ConfigurableTProtocol) {
