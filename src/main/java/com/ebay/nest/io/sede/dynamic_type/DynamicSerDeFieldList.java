...
public class DynamicSerDeFieldList extends DynamicSerDeSimpleNode implements
  ...
  public Object deserialize(Object reuse, TProtocol iprot)
    ...
    boolean fastSkips = iprot instanceof com.ebay.nest.io.sede.thrift.SkippableTProtocol;
    ...
    for (int i = 0; i < getNumFields(); i++) {
      ...
      if (!isRealThrift && getField(i).isSkippable()) {
        ...
        mt = ordered_types[i];
        if (fastSkips) {
          ((com.ebay.nest.io.sede.thrift.SkippableTProtocol) iprot)
              .skip(mt.getType());
        } else {
  ...
  public void serialize(Object o, ObjectInspector oi, TProtocol oprot)
    ...
    for (int i = 0; i < fields.size(); i++) {
      ...
      if (f == null) {
        ((com.ebay.nest.io.sede.thrift.WriteNullsProtocol) oprot)
            .writeNull();
      } else {
