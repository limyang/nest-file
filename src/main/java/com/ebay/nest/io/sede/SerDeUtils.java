...
import com.ebay.nest.io.utils.JavaUtils;
...
public final class SerDeUtils {
  ...
  static {
    nativeSerDeNames
        .add(com.ebay.nest.io.sede.dynamic_type.DynamicSerDe.class
        .getName());
    nativeSerDeNames
        .add(com.ebay.nest.io.sede.MetadataTypedColumnsetSerDe.class
        .getName());
    // For backward compatibility
    nativeSerDeNames.add("org.apache.hadoop.hive.serde.thrift.columnsetSerDe");
    nativeSerDeNames
        .add(com.ebay.nest.io.sede.lazy.LazySimpleSerDe.class.getName());
    nativeSerDeNames.add(com.ebay.nest.io.sede.columnar.ColumnarSerDe.class.getName());
  }
  ...
  protected static boolean registerCoreSerDes() {
    ...
    try {
      ...
      Class
          .forName(com.ebay.nest.io.sede.MetadataTypedColumnsetSerDe.class
          .getName());
      Class.forName(com.ebay.nest.io.sede.lazy.LazySimpleSerDe.class
          .getName());
      Class
          .forName(com.ebay.nest.io.sede.thrift.ThriftDeserializer.class
          .getName());
    } catch (ClassNotFoundException e) {
