...
public class ThriftUtils {
	...
	/**
	 * Returns gereric type for a field in a Thrift class. The type is the return type for the accessor method for the
	 * field (e.g. <code>isFieldName()</code> for a boolean type or <code>getFieldName</code> for other types). The
	 * return type works for both structs and unions. Reflecting directly based on fields does not work for unions.
	 * 
	 ...
	 * @param field
	 *            thrift field.
	 * @return class of field value, or null in the case of thrift types {@link TType#STOP} or {@link TType#VOID}.
	 */
	...
	/**
	 * Deserializes a thrift field that was serilized with {@link #writeFieldNoTag(TProtocol, Field, Object)}.
	 * 
	 * @throws TException
	 *             in case of any Thrift errors.
	 */
